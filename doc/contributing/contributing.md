...
<a id="contributing-patches"></a>

## Contributing

Everyone is welcome to contribute! Design pre-work and general discussion occurs via one of the
communications channels described on the [Community](https://www.spdk.io/community/) page.
...
the @ref core "core maintainers" who can be contacted in Slack.
...
* `Profile`: Verify that the information is correct here. This includes registering the e-mail address in your profile.
  The e-mail address must be registered before generating an HTTP password.
...
* Provide a clear commit message describing the purpose of the commit. Good commit messages provide a very brief summary of
  ...
  being solved, how was it discovered and how this patch solves the problem.  See @ref integration "Continuous Integration" for the special case of a
